...
<html lang="en">
  <head>
    ...
    <title>Sistem Pendukung Keputusan Pemilihan Jurusan DI Universitas</title>
  ...
  <body style="background: #141414 url(images/webb-dark.png) left bottom fixed;">
	  ...
	  <div class="container">
		...
		<div class="navbar-header">
		 <!-- <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
		  ...
		  <a class="navbar-brand" href="index.html">Sistem Pendukung Keputusan Pemilihan Set Top Box Terbaik</a>
		</div>
    ...
    <div class="container">
		<div class="row">
		  ...
		  <div class="col-xs-12 col-sm-4 col-md-4">		
				...
				<br>
				<button type="button" onclick="location.href='user-baru2.php'" class="btn btn-secondary btn-lg btn-block btn-primary">Register</button>
		  	</div></div>
